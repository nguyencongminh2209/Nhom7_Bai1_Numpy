...
open_button = tk.Button(root, text="Chọn ảnh", command=classify_image)
...
# Create a button to clear the selected image and prediction
clear_button = tk.Button(root, text="Xóa", command=clear_image)
